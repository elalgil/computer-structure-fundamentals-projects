...
class CodeWriter:
    ...
    def arithmetic_comparison_commands(self, jmp_type: str) -> str:
        ...
        "M=M-1\n"
        """
        CodeWriter._current_label_arithmetic += 1
        command: str = ""
        command += "@SP\n"
        command += "A=M-1\n"
        command += "D=M\n"
        command += "@POSEY" + str(
            CodeWriter._current_label_arithmetic) + self._file_name + "\n"
        command += "D;JGE\n"
        command += "(NEGY" + str(
            CodeWriter._current_label_arithmetic) + self._file_name + ")\n"
        command += "@SP\n"
        ...
        command += "A=M-1\n"
        command += "D=M\n"
        command += "@PUSHTRUE" + str(
            CodeWriter._current_label_arithmetic) + self._file_name + "\n"
        command += "D;" + jmp_type + "\n"
        command += "@PUSHFALSE" + str(
            CodeWriter._current_label_arithmetic) + self._file_name + "\n"
        command += "0;JMP\n"

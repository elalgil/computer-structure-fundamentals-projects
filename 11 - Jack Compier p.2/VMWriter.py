...
class VMWriter:
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        """
        translator: typing.Dict[str, str] = {"CONST": "constant",
                                             "ARG": "argument",
                                             "VAR": "local",
                                             "STATIC": "static",
                                             "THIS": "this", "THAT": "that",
                                             ...
                                             "TEMP": "temp"}
        self.output.write(
            "push " + translator[segment] + " " + str(index) + '\n')
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        translator: typing.Dict[str, str] = {"CONST": "constant",
                                             ...
                                             "TEMP": "temp"}
        self.output.write(
            "pop " + translator[segment] + " " + str(index) + '\n')
    ...
    def write_arithmetic(self, command: str) -> None:
        ...
        trans = {
            ...
            "MULT": "call Math.multiply 2", "DIV": "call Math.divide 2"
        }
        self.output.write(trans[command] + '\n')
